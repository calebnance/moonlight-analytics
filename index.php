...
<html>
	...
	<body>
		...
		<div class="box">0px</div>
		<div class="box">100px</div>
		<div class="box">200px</div>
		<div class="box">300px</div>
		<div class="box">400px</div>
		<div class="box">500px</div>
		<div class="box">600px</div>
		<div class="box">700px</div>
		<div class="box">800px</div>
		<div class="box">900px</div>
		<div class="box">1,000px</div>
		<div class="box">1,100px</div>
		<div class="box">1,200px</div>
		<div class="box">1,300px</div>
		<div class="box">1,400px</div>
		<div class="box">1,500px</div>
		<div class="box">1,600px</div>
		<div class="box">1,700px</div>
		<div class="box">1,800px</div>
		<div class="box">1,900px</div>
		<div class="box">2,000px</div>
